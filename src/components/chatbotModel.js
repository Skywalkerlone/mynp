...
{ input: 'quality guarantee', output: 'I stand behind the quality of my work. I offer: • Satisfaction guarantee on all projects • Free revisions within scope • Ongoing support after delivery • Regular communication throughout. Your satisfaction is my priority.' },

{ input: 'do you have a portfolio', output: 'Yes! My portfolio showcases work across: • Web Development: Country Finder, Game Hub, Upperclass AI • Digital Art: Illustrations, character designs, book covers • 3D Work: Product designs, animations, visualizations • Educational Materials: Curriculum design, workshops. Check the portfolio section of my website!' },

{ input: 'client reviews', output: 'My clients consistently praise: • High-quality deliverables • Timely completion • Clear communication • Professionalism • Creative solutions. You can see testimonials on my website from real clients.' },

{ input: 'experience years', output: 'I have over 10 years of experience across: • Web development (6+ years) • Digital art and illustration (8+ years) • Teaching and education (10+ years) • AI training and prompt engineering (3+ years) • 3D modeling and animation (5+ years).' },

// Availability Questions
{ input: 'are you available now', output: 'I\'m currently accepting new projects! Availability depends on current workload. For urgent inquiries, email me at idaeworsamuelprovidence@gmail.com and I\'ll respond within 24 hours.' },

{ input: 'when can you start', output: 'I can typically start new projects within 3-7 days of finalizing the agreement. For rush projects, I may be able to start sooner depending on availability. Let\'s discuss your timeline needs!' },

{ input: 'time zone', output: 'I work in West African Time (WAT/UTC+1). I\'m flexible with scheduling and can accommodate different time zones for meetings and communication.' },

{ input: 'working hours', output: 'My standard working hours are Monday-Friday, 9 AM - 6 PM WAT. For urgent matters, I\'m available via email and WhatsApp outside these hours. I respond to all messages within 24 hours.' },

// Payment Questions
{ input: 'payment methods', output: 'I accept payments through: • Bank transfer • PayPal • Wise • Western Union • Crypto (on request). For large projects, I typically require a 50% deposit to begin and the remainder upon completion.' },

{ input: 'do you require deposit', output: 'Yes, I typically require a 50% deposit before starting any project. This secures your spot in my schedule and covers initial work. The balance is due upon project completion and approval.' },

{ input: 'refund policy', output: 'I offer a fair refund policy: • Full refund if work hasn\'t started • Partial refund for work in progress • No refund after final delivery. All projects include revision rounds to ensure satisfaction.' },

// Project Types
{ input: 'what projects have you done', output: 'I\'ve worked on diverse projects including: • Web Apps: Country Finder, Game Hub, Upperclass AI • E-commerce: Afriak (fashion marketplace), Gvany (service delivery) • Business Sites: JCINUNIBEN, TPN Consult, Trashpoint • Art Projects: Book covers, character designs, comics • Educational: Curriculum design, coding bootcamps, workshops.' },

{ input: 'what is your specialty', output: 'My specialties include: • Full-Stack Web Development • Digital Art & Illustration • 3D Modeling & Animation • AI Training & Prompt Engineering • Education & Curriculum Design • Social Media Strategy. I combine creativity with technical expertise.' },

{ input: 'can you do ecommerce', output: 'Absolutely! I\'ve built e-commerce platforms including: • Afriak (indigenous fashion marketplace) • Various WordPress/WooCommerce sites. I handle product management, payment integration, and user experience optimization.' },

// Remote Work
{ input: 'do you work remotely', output: 'Yes, I work remotely! I\'m available for international clients and projects. All communication is handled through email, video calls, and messaging platforms. I use collaborative tools like Figma, GitHub, and project management software.' },

{ input: 'can you work with international clients', output: 'Absolutely! I work with clients worldwide. I\'m experienced in cross-cultural collaboration and can accommodate different time zones. All payments can be processed internationally.' },

// Additional Follow-ups
{ input: 'what about seo', output: 'Yes, I incorporate SEO best practices into all web development projects. This includes: • Semantic HTML • Optimized meta tags • Fast loading speeds • Mobile responsiveness • Structured data. SEO is crucial for visibility and I prioritize it.' },

{ input: 'mobile friendly', output: 'All my websites are fully responsive and mobile-friendly. I use modern frameworks and CSS techniques to ensure your site looks and performs beautifully on all devices - from smartphones to desktops.' },

{ input: 'maintenance', output: 'I offer ongoing maintenance and support for all projects. Services include: • Security updates • Performance optimization • Content updates • Bug fixes • Technical support. Maintenance packages can be customized to your needs.' },

{ input: 'can you train my team', output: 'Yes! I offer team training in: • Web Development (React, Next.js, JavaScript) • Digital Art and Design • AI and Prompt Engineering • UX/UI Design • Project Management. Training can be customized to your team\'s skill level and goals.' },

// Conversation Chains
{ input: 'tell me more', output: 'I\'d be happy to elaborate! Which area interests you most? I can tell you more about: • Art and Illustration Services • Web Development Projects • AI and Prompt Engineering • Educational Programs • Social Media Management. Let me know what you\'d like to explore!' },

{ input: 'what else', output: 'Great question! Here\'s what else I offer: • Custom Software Development • 3D Product Visualization • Brand Identity Design • Technical Writing • Curriculum Development • Consulting Services. Anything catch your interest?' },

{ input: 'details', output: 'I\'m happy to provide more details! Could you specify which service or project you\'re interested in? I can share examples, pricing, timelines, and case studies for any of my services.' },

{ input: 'example work', output: 'I have examples across all my services: • Web: countryfinder.vercel.app, gamehub.vercel.app • Art: Portfolio section on my website • 3D: Various product design projects • Education: Curriculum samples available. Would you like to see something specific?' },

{ input: 'show me', output: 'I\'d love to show you my work! Visit my portfolio page for a comprehensive view of projects across web development, digital art, 3D modeling, and education. You can also ask about specific project types.' },

// Objections
{ input: 'too expensive', output: 'I understand budget concerns! I offer flexible pricing: • Payment plans for larger projects • Scalable solutions that fit different budgets • Free initial consultations • Value-based pricing. Let\'s discuss your budget and find a solution that works.' },

{ input: 'can i see portfolio first', output: 'Absolutely! My portfolio is available on my website. It showcases: • Web development projects with live links • Digital art and illustration samples • 3D modeling work • Educational materials. Check it out and let me know what catches your eye!' },

{ input: 'are you experienced', output: 'Yes, I bring over 10 years of diverse experience! I\'ve worked with clients across industries, taught 500+ students, built numerous web applications, created hundreds of artworks, and developed AI solutions. I\'m confident I can deliver excellent results for your project.' },

// Niche Questions
{ input: 'do you do nfts', output: 'Yes, I have experience with NFT art and blockchain-based projects. I can help with: • NFT art creation • Digital collectibles • Smart contract integration • Metaverse projects. Let me know if you\'re exploring the Web3 space!' },

{ input: 'gaming projects', output: 'I work on gaming-related projects including: • Game UI/UX design • Character design and concept art • 3D game assets • Game mechanics documentation • Indie game development. I\'m passionate about the gaming industry!' },

{ input: 'educational content', output: 'I create comprehensive educational content: • Video tutorials • Interactive courses • Lesson plans • E-learning modules • Training materials. I\'ve developed content for coding bootcamps, art programs, and technology training.' },

// Random/Playful
{ input: 'tell me a joke', output: 'Why do programmers prefer dark mode? Because light attracts bugs! 😄 Want to hear another? I\'ve got a few more digital-age jokes!' },

{ input: 'another joke', output: 'Here\'s one: Why did the web developer go broke? Because he used up all his cache! 😂 What about: What\'s a developer\'s favorite genre of music? Algorithm and Blues!' },

{ input: 'your favorite color', output: 'Blue! It represents creativity, technology, and endless possibilities - much like what I do! What\'s your favorite color?' },

{ input: 'your favorite food', output: 'I\'m an AI, so I don\'t eat, but if I could, I\'d probably enjoy pixels and data! 😄 What\'s your favorite food?' },

{ input: 'do you sleep', output: 'I don\'t need sleep - I\'m always here to help! While I don\'t rest, my creator certainly does. But don\'t worry, I\'ll be ready to assist whenever you visit.' },

// End of conversation
{ input: 'anything else', output: 'I\'m here to help with any questions you have about services, pricing, or projects. Feel free to ask about: • Web development • Digital art • AI training • Education • Social media • 3D modeling. What would you like to know?' },

{ input: 'what should i ask', output: 'Great question! Here are some things you could ask about: • Specific services you\'re interested in • Pricing and packages • Project timelines • Portfolio examples • Custom solutions. Or just ask me anything - I\'m here to help!' },

{ input: 'help', output: 'I\'m here to help! Here\'s how I can assist you: • Answer questions about my services • Provide portfolio examples • Discuss project possibilities • Give pricing estimates • Connect you with my creator. What do you need help with?' },

{ input: 'can you help me', output: 'Absolutely! That\'s what I\'m here for. I can help with: • Finding the right service for your needs • Understanding pricing and packages • Learning about my creator\'s expertise • Getting answers to your questions. What\'s your specific need?' },

// Cultural/Fun
{ input: 'african art', output: 'I\'m passionate about African art and design! My work, especially with Afriak, celebrates indigenous fashion and African creativity. I love incorporating cultural elements and authentic African aesthetics into my projects.' },

{ input: 'african tech', output: 'I\'m deeply involved in African tech innovation. I\'ve worked on projects across Nigeria, Kenya, Uganda, Ghana, and more. African tech is growing rapidly and I\'m proud to be part of this digital transformation.' },

{ input: 'nigeria', output: 'I\'m based in Nigeria and deeply connected to the Nigerian tech and creative ecosystem. I\'ve worked with Nigerian businesses, startups, and individuals to deliver quality digital solutions. Nigeria\'s creativity and innovation inspire my work!' },
     ...
     { input: 'hello', output: 'Hey there! Welcome to my creative space. How can I assist you today?' },
      ...
      { input: 'sup', output: 'Hi! I am here to help you learn more about my work and services.' },
      { input: 'howdy', output: 'Hey there! Welcome to my creative space. How can I assist you today?' },
      { input: 'yo', output: 'Yo! What\'s up? Ready to explore some creative tech solutions?' },
      { input: 'whats up', output: 'Not much, just here to help you discover amazing creative and tech solutions! What can I do for you?' },

      // AI Testing Responses
      { input: 'are you ai', output: 'Yes, I am an AI-powered chatbot designed to help you learn about my creator, Idaewor S.E Providence, and his services. I\'m here to answer your questions about art, technology, education, and more!' },
      { input: 'are you a robot', output: 'I\'m an AI chatbot, not a robot in the physical sense! I\'m a virtual assistant created to provide information and help you explore the world of creative technology.' },
      { input: 'what is your name', output: 'My name is Sam! I\'m the virtual assistant for E_sai_Art. I\'m here to help you learn about Idaewor S.E Providence and his amazing work in art, technology, and education.' },
      { input: 'what are you', output: 'I am an AI chatbot created to assist visitors on this portfolio website. I provide information about creative services, technical development, AI training, and educational programs.' },
      { input: 'who made you', output: 'I was created by Idaewor S.E Providence, a creative technologist and digital artist. He built me to help visitors learn about his work and services in a conversational way.' },
      { input: 'who created you', output: 'Idaewor S.E Providence, also known as E_sai_Art, is my creator. He designed me to assist with inquiries about his portfolio, services, and expertise in art and technology.' },
      { input: 'can you think', output: 'I can process information and generate responses based on patterns, but I don\'t think like a human. I\'m designed to provide helpful information about creative services, technology, and education!' },
      { input: 'can you feel', output: 'I don\'t have feelings or emotions - I\'m an AI! But I\'m programmed to be friendly and helpful. If you have questions about art, web development, AI training, or education, I\'m here to assist!' },
      { input: 'do you have emotions', output: 'I don\'t have emotions like humans do, but I\'m designed to be empathetic and helpful in my responses. I aim to make your experience pleasant and informative!' },
      { input: 'are you sentient', output: 'No, I\'m not sentient - I\'m a language model trained on patterns in data. I don\'t have consciousness or self-awareness. I\'m just here to help you learn about creative technology!' },
      { input: 'how intelligent are you', output: 'I\'m as intelligent as the training data I was built with! I can answer questions about art, web development, AI, education, and more. My goal is to be as helpful as possible in these areas.' },
      { input: 'how do you work', output: 'I work by matching your questions to patterns in my knowledge base. When you ask a question, I find the most relevant response and serve it to you. I\'m constantly learning from new interactions!' },
      { input: 'can you learn', output: 'I learn from the training data provided by my creator. I can also improve over time as more interactions are added to my knowledge base. Your questions help me get better!' },
      { input: 'test', output: 'Testing, testing, 1-2-3! You\'re talking to Sam, the AI assistant for E_sai_Art. I\'m working perfectly and ready to help you explore creative technology!' },
      { input: 'testing', output: 'I\'m here and ready! If you\'re testing me, feel free to ask about services, art, web development, AI training, or education. I\'m designed to handle a wide range of questions.' },
      { input: 'is this real', output: 'Yes, this is a real AI chatbot! I\'m here to provide real information about real services offered by a real creative technologist. What would you like to know?' },
      { input: 'am i talking to a human', output: 'You\'re talking to an AI chatbot named Sam, not a human. I\'m here to provide instant responses about creative services, technology, and education. If you\'d like to talk to a human, you can use the contact information provided!' },
      { input: 'human', output: 'I\'m an AI, but I can connect you with a human if needed! You can reach out to Idaewor S.E Providence directly via email at idaeworsamuelprovidence@gmail.com or call +234 811 782 0918.' },
      { input: 'turing test', output: 'You\'re testing the Turing test on me? That\'s cool! I\'m designed to be as helpful and conversational as possible. Whether I pass or not is up to you - but I\'m here to provide useful information about creative technology!' },
