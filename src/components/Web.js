...
function ProjectCard({ project, index }) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="project-card flex flex-col md:flex-row items-center md:gap-8 bg-slate-100 dark:bg-slate-800 rounded-xl shadow-lg p-4"
    >
      <Image
      ...
      <div className="mt-4 md:mt-0 md:w-1/2">
        ...
        <a
          ...
          className="inline-block bg-blue-600 dark:bg-blue-400 px-4 bg-shine py-2 rounded-lg hover:scale-105 transition"
        >
          View Website
        </a>
      </div>
  ...
  return (
    <section id="web" className="py-16 bg-white dark:bg-slate-900 text-slate-900 dark:text-white">
      ...
      >
        <Link href="#services">
          <button
            className="bg-gradient-to-r from-white/20 via-white/10 to-white/5 backdrop-blur-md p-6 shadow-lg border border-white/30 text-white px-6 py-3 rounded-xl hover:scale-105 transition"
